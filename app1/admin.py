...
from app1.models import User,Event,Notification,Resources,Insta,Attendance,Non_vitians,recruitment,Idea
# Register your models here.
@admin.register(User)
class PersonAdmin(ImportExportModelAdmin):
    search_fields=['user_reg_no','user_email','user_phone','user_first_name','user_last_name','user_post']
    list_display=['user_first_name','user_last_name','user_reg_no','is_ffcs','user_email','user_phone','user_post','user_Codeforces_id']
...
class recruitAdmin(ImportExportModelAdmin):
    list_display=['full_name','regno','phone','email','department']
    search_fields=['full_name','regno','phone','email','department']
